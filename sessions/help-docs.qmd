...
| Method | Session |
|--------|---------|
| Setting up R and packages | @sec-packages |
| Vectors and basic data types | @sec-vectors |
| Data wrangling (dplyr, tidyr) | @sec-wrangling |
| Reproducible reports (Quarto) | @sec-reproducible |
| Descriptive statistics | @sec-descriptive |
| Basic visualisation (ggplot2) | @sec-basic-viz |
| Advanced visualisation | @sec-advanced-viz |
| Exploring clinical data | @sec-explore-clinical |
| Sampling and estimation | @sec-sampling |
| Hypothesis testing framework | @sec-hypothesis |
| t-tests | @sec-ttests |
| Non-parametric tests | @sec-nonparametric |
| ANOVA | @sec-anova |
| Categorical data and chi-square | @sec-chisquare |
