...
ggplot2 is one of the most powerful and flexible tools for data visualization in R. ggplot2 is part of a widely used collection of packages and is based on the Grammar of Graphics, a framework for creating graphics in a structured and intuitive manner. With ggplot2, you can create a wide range of static and interactive plots, from simple scatter plots to complex multi-layered graphics.
...
- Visualization and `ggplot2`: @Wickham-2016-ggplot2; @Chang-2018.
- Practical plotting recipes: @Wickham-Grolemund-2017.

## Resources

- Example demos moved from `dev_code_data`; use inline examples above or see `data_sources.md` for dataset and demo script suggestions.
