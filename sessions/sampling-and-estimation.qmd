...
- Use the inline examples above or see `data_sources.md` for recommended public datasets and load snippets.

**Exercises**

- Compute 95% confidence intervals for BMI and interpret them using the inline examples or a recommended dataset from `data_sources.md`.
...
- Primary example materials are provided inline above; see `scripts/` for canonical exercise scripts or `data_sources.md` for dataset load snippets and replacements.
