...
> Bilirubin and prothrombin time both predict albumin � but they are correlated with each other. Multiple regression lets you ask: "What is the effect of bilirubin on albumin, *holding prothrombin time constant*?" It adjusts for confounders and allows you to model a continuous outcome with several predictors simultaneously.
