...
- Examples and loaders: `R/load-packages.R` (canonical); scripts previously in `dev_code_data` were moved to `scripts/` or `R/` — see `data_sources.md` for recommended loaders and usage.
