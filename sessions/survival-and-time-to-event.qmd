...
- **log_bili:** Each one-unit increase in log(bilirubin) multiplies the hazard of death by the HR --- roughly a 2.7-fold increase in bilirubin on the original scale.
- **albumin:** Each 1 g/dL increase in albumin is associated with HR < 1, i.e., lower hazard (protective).
- **stageStage 4:** Stage 4 patients have HR times the hazard of Stage 1 patients, after adjustment.
