...
**Epidemiological methods textbooks:** Often provide study datasets. sRothman-2012 includes Examples from case-control and cohort designs.
...
**Collider bias**
Adjusting for a variable on the causal pathway (a collider) can open a spurious association between exposure and outcome. See ssec-causal for a Example.
