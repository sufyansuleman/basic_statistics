...
|---------|-----------------|--------|---------|
| Continuous | Normal, equal variance | Independent t-test | @sec-ttests |
| Continuous | Normal, unequal variance | Welch t-test | @sec-ttests |
| Continuous | Non-normal or n < 30 | Mann-Whitney U | @sec-nonparametric |
| Continuous, paired | Normal differences | Paired t-test | @sec-ttests |
| Continuous, paired | Non-normal differences | Wilcoxon signed-rank | @sec-nonparametric |
| Binary | Counts ≥ 5 per cell | Chi-square / Fisher's | @sec-chisquare |
...
| Binary | Counts ≥ 5 | Chi-square (k × 2 table) | @sec-chisquare |
...
| Binary–Binary | Phi coefficient / chi-square | @sec-chisquare |
...
| Two proportions | Chi-square / Fisher's exact | @sec-chisquare |
...
**Decision path:** Continuous outcome → Paired groups → Normal differences → **Paired t-test** → @sec-ttests
